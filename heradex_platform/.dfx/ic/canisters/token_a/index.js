...
export const canisterId = process.env.CANISTER_ID_TOKEN_A;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_a.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_a canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_a.did.js")._SERVICE>}
 */
export const token_a = createActor(canisterId);
