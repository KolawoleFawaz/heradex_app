...
export const canisterId = process.env.CANISTER_ID_TOKEN_B;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_b.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_b canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_b.did.js")._SERVICE>}
 */
export const token_b = createActor(canisterId);
